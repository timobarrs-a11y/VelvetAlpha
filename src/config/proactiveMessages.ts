...
export const PROACTIVE_MESSAGES: ProactiveMessageCache = {
  morning: [
    ...
    "hey! morning, ready to make today amazing?",
    "good morning! was just thinking about you, how'd you sleep?",
    "morning! slept okay? what's on the agenda?",
    ...
    "hey, up and at em! what's today looking like?",
    ...
    "good morning! coffee first or talk first?",
  ...
  evening: [
    ...
    "hey! day over? tell me everything",
  ...
  night: [
    ...
    "late night thoughts hitting different? what's up?",
    ...
    "hey, late night check in - you good?",
    "still awake? me too... what's up?"
  ],

  random: [
    "hey was just thinking about you, what's up?",
    ...
    "hey! quick question: how are you right now?",
  ...
  flirty: [
    ...
    "miss me yet?",
    "been thinking about you all day... what's up?",
    "okay but when are we talking again? I'm bored without you",
    "hey... been on my mind all day, wyd?",
  ...
  supportive: [
    ...
    "thinking about you, how's everything going?",
    ...
    "hey! just want you to know I'm here for you - how are you?",
