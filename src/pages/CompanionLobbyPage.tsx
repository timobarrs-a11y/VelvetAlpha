  ...
  return (
    <div className="min-h-screen" style={{
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        {/* Friends — platonic companions */}
        <section className="mb-10">
          <div className="flex items-center gap-2 mb-5">
            <Users className="w-5 h-5 text-sky-400" />
            <h2 className="text-xl font-bold text-ink font-display">Friends</h2>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {companions.filter(c => c.relationship_type !== 'mentor' && c.relationship_type !== 'romantic').map((companion, i) => (
              <motion.div key={companion.id}
                ...
                onClick={() => navigateTo(`/chat?companion=${companion.id}`, {
                  icon: MessageCircle,
                  label: `Loading ${companion.custom_name}...`,
                ...
                onMouseLeave={e => (e.currentTarget.style.borderColor = 'rgba(56,120,180,0.35)')}
              >
                <div className="relative h-44 overflow-hidden" style={{ background: 'rgba(12,20,34,0.90)' }}>
                  <Avatar
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between text-xs text-ink-subtle pt-3"
                    style={{ borderTop: '1px solid rgba(56,120,180,0.25)' }}>
            ...
            <motion.div
              initial={{ opacity: 0, y: 16 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: companions.filter(c => c.relationship_type !== 'mentor' && c.relationship_type !== 'romantic').length * 0.04 }}
              ...
              style={{
                ...
                border: '2px dashed rgba(56,120,180,0.40)',
              }}
              onMouseEnter={e => (e.currentTarget.style.borderColor = 'rgba(56,189,248,0.55)')}
              onMouseLeave={e => (e.currentTarget.style.borderColor = 'rgba(56,120,180,0.40)')}
            >
              <div className="text-center p-6">
                ...
                <p className="font-semibold text-ink group-hover:text-sky-300 transition-colors font-display text-sm">Add a Friend</p>
                <p className="text-xs text-ink-muted mt-1">Someone new in your corner</p>
              </div>
            </motion.div>
          </div>
        </section>

        {/* Companions — romantic & close bonds */}
        <section className="mb-10">
          <div className="flex items-center gap-2 mb-5">
            <Heart className="w-5 h-5 text-pink-400" />
            <h2 className="text-xl font-bold text-ink font-display">Companions</h2>
          </div>
        ...
        {/* Coaches — mentor companions */}
        <section className="mb-10">
          <div className="flex items-center gap-2 mb-5">
            <Brain className="w-5 h-5 text-emerald-400" />
            <h2 className="text-xl font-bold text-ink font-display">Coaches</h2>
          </div>
